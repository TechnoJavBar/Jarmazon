# Generated by Django 5.1.3 on 2025-02-12 18:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gestionAlm.categoria')),
            ],
        ),
        migrations.CreateModel(
            name='DetallePedido',
            fields=[
                ...
                ('Pedido', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gestionAlm.pedidoweb', verbose_name='pedido')),
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gestionAlm.producto', verbose_name='productoPedido')),
            ],
        ),
    ]
